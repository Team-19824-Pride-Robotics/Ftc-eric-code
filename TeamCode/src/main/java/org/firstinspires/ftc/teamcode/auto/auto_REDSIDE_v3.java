...
@Autonomous(name = "auto_REDSIDE_v3")
@Configurable

public class auto_REDSIDE_v3 extends OpMode {
...
//interval for initial kick into flywheel
    ...
    private boolean kickInitialized = false;
    private boolean settleInitialized = false;
    public void startTripleLaunch() {
