...
//interval for initial kick into flywheel
    ...
    private final Pose lineup1Pose = new Pose(47, lineupY1, Math.toRadians(180));
    ...
    private final Pose lineup2Pose = new Pose(47, lineupY2, Math.toRadians(180)); // Middle (Second Set)
